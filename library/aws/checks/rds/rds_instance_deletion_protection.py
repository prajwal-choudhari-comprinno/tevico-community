...
class rds_instance_deletion_protection(Check):
    def execute(self, connection: boto3.Session) -> CheckReport:
        ...
        try:
            ...
            # Check each RDS instance for deletion protection
            for instance in instances:
                ...
                try:
                    ...
                    if deletion_protection:
                        summary = f"Deletion protection is enabled for RDS instance {instance_name}."
                        status = CheckStatus.PASSED
                    else:
                        summary = f"Deletion protection is NOT enabled for RDS instance {instance_name}."
                    ...
                    report.resource_ids_status.append(
                        ResourceStatus(
                            ...
                            summary=f"Error retrieving deletion protection status for {instance_name}: {str(e)}",
                            exception=str(e)
                        )
                    )
